...
export function ProjectCard({
  ...
  return (
    <div ref={revealRef} className="reveal reveal-scan">
      <div
        ref={spotRef}
        onMouseMove={onMouseMove}
        className={`glass-panel rounded-xl p-0 overflow-hidden card-spotlight card-hover transition-all duration-500 flex flex-col ${rowClass} group`}
      >
        ...
        <div className="p-6 md:p-8 w-full md:w-2/3 flex flex-col justify-center relative z-10">
