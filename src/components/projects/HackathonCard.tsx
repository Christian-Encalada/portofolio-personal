  ...
  return (
    <div className={colSpan ?? ''}>
      <div
        ...
        className="glass-panel rounded-xl p-6 relative overflow-hidden card-spotlight card-hover transition-all duration-500 flex flex-col justify-between group h-full min-h-[220px]"
      >
