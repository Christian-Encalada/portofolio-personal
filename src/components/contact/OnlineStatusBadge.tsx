...
export function OnlineStatusBadge({ label, className = '' }: OnlineStatusBadgeProps) {
  return (
    <div
      className={`online-badge-pulse inline-flex items-center gap-2 px-3 py-1 border border-primary-container/30 bg-primary-container/5 rounded-full ${className}`}
    >
