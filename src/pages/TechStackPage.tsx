...
export function TechStackPage() {
  ...
  return (
    <main className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pt-40 pb-32 relative z-10">
      <Reveal variant="reveal-terminal" className="mb-20 md:mb-28 relative inline-block">
      ...
      <Reveal variant="reveal-stagger" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter items-stretch">
