...
export function HomePage() {
  ...
  return (
    <main className="flex-grow flex flex-col justify-center pt-28 pb-12 px-margin-mobile md:px-margin-desktop w-full max-w-container-desktop mx-auto relative z-10 min-h-screen">
